...
import { Badge, BottomNavigation, BottomNavigationAction, Button, Checkbox, IconButton } from '@mui/material';
import { BackupTable, Category, CheckBox, Inventory } from '@mui/icons-material';
...
const Groups2 = () => {
    ...
    function handleGroupCheckboxChange(event) {
          ...
          if (event.target.checked) {
            ...
            setSelectedGroup(selectedGroup.filter(selectedGroup => selectedGroup !== GroupTitle));
          }
        }
  ...
  return (
    ...
    <WrapperWhole>
      ...
      <WrapperTit>
        ...
        <Sort>
            <Button variant="outlined"sx={{margin:"2vh"}} onClick={handleGroupSend}> ADD ALL</Button>
        </Sort>

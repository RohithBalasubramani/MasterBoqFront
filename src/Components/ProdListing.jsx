...
import { Box, Checkbox, FormControl, Grid, InputLabel, MenuItem, Select, Slider } from '@mui/material'
    ...
    <div>
      ...
      <ul>
        {filteredProducts.map((product) => (
          <li key={product.id}>
            <a href={`/products/${product.id}`}>{product.ProductName}........{product.Price}</a> - ${product.Brand}
          </li>
        ))}
      </ul>
    </div>
